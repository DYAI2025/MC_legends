...
const required = [
  ...
  "src/domain/replies/reply.ts",
  "src/application/replies/submission-reply-log.ts",
  "src/application/replies/submission-reply-reader.ts",
  "src/application/replies/compose-reply.ts",
  "src/adapters/persistence/file-submission-reply-log.ts",
  "src/adapters/persistence/postgres-submission-reply-log.ts",
  "src/app/components/family-replies.tsx",
  "src/app/components/admin-reply-form.tsx",
  "src/app/reply-message.ts",
  "db/migrations/0004_submission_reply.sql",
